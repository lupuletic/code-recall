...
|----------|-------|-------------|
| Exact project names | **7/7** | "payments api", "customer portal", "release tools" |
| Describing work done | **8/9** | "fixing webhook signatures", "setting up release automation" |
| Semantic / conceptual | **6/6** | "the checkout retry issue", "slow dashboard query" |
| Technology queries | **6/6** | "docker healthcheck", "telegram webhook setup" |
| Last message context | **2/2** | "push the latest to remote", "what was left before release" |
