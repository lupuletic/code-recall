"""Tests for code_recall.searcher."""
...
from code_recall.searcher import (
    _apply_depth_boost,
...
class TestCrossEncoderRerank:
    ...
    @patch("code_recall.embedder.get_reranker")
    ...
    @patch("code_recall.embedder.get_reranker", return_value=None)
...
class TestBranchDetection:
    def test_git_checkout_b_detects_branch(self):
        ...
        from code_recall.utils import parse_session_file
        import json
        import tempfile
        import os
